...
async function attioFetch<T = unknown>(path: string, options: RequestInit = {}): Promise<T> {
...
export async function GET() {
  try {
    ...
    const prospects = results.filter((r): r is UncontactedProspect => r !== null);
